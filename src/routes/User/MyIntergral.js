...
class MyIntergral extends Component {
  constructor(props) {
    super(props)
    this.state = {
      nums:30,									// 倒计时时间（s）
      ...
      <div className="father">
        ...
        <div className="box">
          ...
          <div className="input-group input-group-lg input-css">
            ...
            <Countdown ref="countdown" status={this.state.status} nums={30} sendCode={this.sendCode} callback={this.onChildChange} disableClick='先把手机号填正确好吗0.0' sendingClick='再等等哦，很快就能收到了' />
          </div>
...
MyIntergral.childContextTypes = {
  color: PropTypes.string
};

export default MyIntergral;

  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        request('http://101.132.194.204:8080/lecheng/public/index/index/loginAction', {
          method: 'POST',
          body: formData,
        }).then((data) => {
          ...
          <Form onSubmit={this.handleSubmit} className="login-form" style={{ width: '45%', margin: '0 auto' }}>
            ...
            <FormItem>
              {getFieldDecorator('password', {
                ...
                <Input
                  style={{ height: '45px' }} prefix={<Icon type="lock" style={{ color: 'rgba(0,0,0,1)' }} />} type="password"
